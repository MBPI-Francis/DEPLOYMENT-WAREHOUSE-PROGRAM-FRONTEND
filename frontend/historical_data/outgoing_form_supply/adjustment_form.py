...
class AdjustmentForm:
    ...
    def add_records(self, item):
        ...
        ToolTip(self.ref_form_number_entry, text="This is the reference number of the outgoing form you will be adjusting")
...
# --------------------------------------------------[INCORRECT DETAILS]---------------------------------------------------
        ...
        ToolTip(incorrect_warehouse_combobox, text="Choose a warehouse")
