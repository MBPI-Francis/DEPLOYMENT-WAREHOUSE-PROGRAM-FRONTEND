...
class OutgoingFormTable:
    def __init__(self, root):
        ...
        self.confirmation_message = ConfirmationMessage(self.root, self, "outgoing")
    ...
    def refresh_table(self):
        ...
        url = server_ip + "/api/outgoing_reports/v2/list/historical/"
    ...
    def sort_column(self, col, reverse):
        ...
        def custom_sort(item):
            ...
            elif col in ("Outgoing Date", "Date Computed"):
                try:
            ...
            # Try sorting numerically if possible (e.g., OGR No.)
            else:
                try:
                    return float(val.replace(",", ""))
                except ValueError:
